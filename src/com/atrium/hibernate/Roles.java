...
public class Roles implements java.io.Serializable {
	...
	private Set usuarioavions = new HashSet(0);
	...
	public Roles(Byte codigoRol, String descripcionRol, Set tareases,
		...
		this.usuarioavions = usuarioavions;
	}
	...
	public Set getUsuarioavions() {
		return this.usuarioavions;
	}

	public void setUsuarioavions(Set usuarioavions) {
		this.usuarioavions = usuarioavions;
	}
