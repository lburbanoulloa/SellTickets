...
/**
 * Motor propio de ejecucion de expresiones en JDK7 para su uso en clases de
 * java.
 * 
...
public class Ejecucion_Expresiones {
	 ...
	 *            Tipo variable del valor de retorno.
	...
	public static <T> T tratar_Expresion(String expresion,
		...
		// PREPARAMOS LOS OBJETOS NECESARIOS DEL CONTEXTO DE JSF PARA
		// REALIZAR EL TRABAJO
		FacesContext facesContext = FacesContext.getCurrentInstance();
		// OBJETO DE JSF QUE EJECUTA LA EXPRESION
		ELContext elContext = facesContext.getELContext();
		// OBJETO DE JSF PARA EL ACCESO A LOS COMPONENTES INTERNOS (NO
		// VISTAS)
		Application application = facesContext.getApplication();
		// OBJETO PARA LA CREACION DE LANZADORES DE EXPRESIONES
		ExpressionFactory expressionFactory = application
				.getExpressionFactory();
		// PREPARAMOS UN LANZADOR DE EXPRESIONES PARA LA VISTA EN LA QUE
		// ESTAMOS
